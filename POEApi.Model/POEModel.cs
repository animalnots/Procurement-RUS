...
namespace POEApi.Model
{
    public class POEModel
    {
        ...
        public bool Authenticate(string email, SecureString password, bool offline, bool useSessionID, ref String accname)
        {
            if (transport != null)
            ...
            transport.Authenticate(email, password, useSessionID, ref accname);
